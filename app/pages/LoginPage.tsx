...
export default function LoginPage() {
  ...
  const getErrorMessage = (error: string) => {
    const errorMappings: Record<string, string> = {
      'Invalid credentials': 'Invalid credentials. Please check your user ID and password.',
      'User not found': 'User not found. Please confirm your user ID.',
      'Please check your input': 'Please check your input and try again.',
      'Network error occurred': 'Could not verify credentials. Please check your connection and try again.',
        ...
        >
          ...
          >
            ...
            <Typography variant="h6" sx={{ opacity: 0.9 }}>
              REPUBLIC OF THE STATES OF KICSLAND
            </Typography>
            ...
            >
              {`+========================================+
|%%%%%%%  NATIONAL RESERVE NOTE  %%%%%%%%|
|%(1)  REPUBLIC OF THE STATES OF KICSLAND (1)%|
|%$$              ___       ********  $$%|
|%$    (x)       (o o)                 $%|
|%$     ******  (  V  )      ONE DOLLAR   $%|
|%(1)          ---m-m---             (1)%|

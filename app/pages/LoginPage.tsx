...
export default function LoginPage() {
  ...
  const validateForm = useCallback(() => {
    ...
    if (!formData.userId.trim()) {
      ...
      errors.userId = 'O ID de usuário deve ter no máximo 8 caracteres.';
    }
  ...
  const getErrorMessage = (error: string) => {
    const errorMappings: Record<string, string> = {
      'Invalid credentials': 'Credenciais inválidas. Verifique seu ID de usuário e senha.',
      'User not found': 'Usuário não encontrado. Confirme seu ID de usuário.',
      'Please check your input': 'Verifique os dados informados e tente novamente.',
      'Network error occurred': 'Não foi possível verificar as credenciais. Verifique sua conexão e tente novamente.',
  ...
  // Não exibir o formulário se o usuário já estiver autenticado
      ...
      <Container maxWidth="md" sx={{ py: 4 }}>
        <Box sx={{ textAlign: 'center' }}>
          ...
          <Typography variant="body1" color="text.secondary">
            Você já está conectado. Redirecionando para o painel.
          </Typography>
        </Box>
      </Container>
    );
      ...
      <Box onKeyDown={handleKeyDown} tabIndex={-1}>
        ...
        <Box sx={{ position: 'relative' }}>
            <SystemHeader
              ...
              title="CardDemo - Aplicação Demo"
              subtitle="Modernização de Mainframe"
              showNavigation={false}
              transactionLabel="Trans.:"
              programLabel="Prog.:"
            />
        ...
        >
          ...
          >
            ...
            <Typography variant="h6" sx={{ opacity: 0.9 }}>
              REPÚBLICA DOS ESTADOS DE KICSLAND
            </Typography>
            
            {/* Bilhete ASCII com espaçamentos preservados */}
            <Box
              sx={{
                mt: 2,
                p: 2,
            ...
            >
              {`+========================================+
|%%%%%%  NOTA DA RESERVA NACIONAL  %%%%%%|
|%(1)  REPÚBLICA DOS ESTADOS DE KICSLAND (1)%|
|%$$              ___       ********  $$%|
|%$    (x)       (o o)                 $%|
|%$     ******  (  V  )      UM DÓLAR    $%|
|%(1)          ---m-m---             (1)%|
...
+========================================+`}
          ...
          {/* Remaining copy updates for English experience */}
          <Box sx={{ p: 4 }}>
            <Typography
              variant="h6"
              color="primary.main"
            ...
            >
              <Stack spacing={3}>
                <TextField
                  ...
                  helperText={fieldErrors.userId || 'Até 8 caracteres'}
                  disabled={isLoading}
                  autoFocus
                  inputProps={{
                    maxLength: 8,
                ...
                <TextField
                  ...
                  helperText={fieldErrors.password || 'Até 8 caracteres'}
                  disabled={isLoading}
